alter table public.case_variants
  add column if not exists address_form text not null default 'formal'
...
comment on column public.negotiation_cases.address_form is
  'Единая форма обращения участников во всех диалогах кейса: formal — на «вы», informal — на «ты».';
...
begin
  ...
  select
    ...
    title, summary, situation, conflict, address_form, user_role, opponent_role, additional_roles, negotiation_pairs,
