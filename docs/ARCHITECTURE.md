...
Канонический кейс хранит ситуацию, центральный конфликт, публичные и скрытые параметры обеих ролей, интересы, ограничения, рычаги, ставки, стартовую позицию, причину сложности, критерии оценки и ссылки на методические атомы. Скрытые мотивы используются серверным Realtime-промптом и не показываются участнику как готовый ответ.
