...
Статус: реализация v0.5. Голосовой прототип работает; книга импортирована в приватный Supabase Storage и pgvector. Все 34 атома временно подтверждены владельцем как `tarasov-v1` до полноценной экспертной перепроверки. Реализованы библиотека кейсов, быстрая загрузка, AI-конструктор из нескольких материалов и подключение выбранного канонического кейса к Realtime-роли и итоговому анализу.
