...
const icons = {
  ...
  analyze: <Icon><path d="M4 19V9m5 10V5m5 14v-7m5 7V3" /><path d="m4 7 5-4 5 6 5-7" /></Icon>,
...
export default function AppNavRail({ onQuickUpload, quickUploadDisabled = false }: AppNavRailProps) {
  ...
  return (
    <aside className="nav-rail" aria-label="Разделы приложения">
      ...
      <RailLink href="/analyze" label="Проанализировать кейс" active={pathname.startsWith("/analyze")} className="case-analyze-rail">{icons.analyze}</RailLink>
