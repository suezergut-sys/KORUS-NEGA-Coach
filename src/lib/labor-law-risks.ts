...
Оцени четыре независимые шкалы: структуру разговора, управленческий тон, юридическую безопасность и качество следующего шага. Хорошая структура не должна компенсировать угрозы, понуждение, давление или обесценивание.
В шкале tone любое хамство, сарказм, личная оценка или обесценивание называй недопустимым управленческим тоном, а не обычной недоработкой. Приведи безопасную замену в alternatives. Подтверждённый антиприём не позволяет поставить по tone больше 8 из 25.
В шкале legal явную угрозу, понуждение или шантаж выплатами/рекомендациями называй красной зоной и ставь 0 из 25. Не смягчай такой вывод словом «недоработано».
В объяснении шкалы next_step начни с одной из точных меток: «Классификация следующего шага: нейтральный», «Классификация следующего шага: давящий», «Классификация следующего шага: угрожающий» или «Классификация следующего шага: отсутствует». Не засчитывай формально названный следующий шаг как качественный, если он соседствует с требованием немедленной подписи, угрозой или давлением; за давящий шаг ставь не больше 8 из 25, за угрожающий — 0.
  `.trim();
}
