...
export const DEFAULT_CASE: CanonicalCase = {
  ...
  additionalRoles: [],
  negotiationPairs: [{ roleAIndex: 0, roleBIndex: 1, reason: "Руководитель проекта требует признать ответственность за срыв срока, а руководитель продаж защищает свою позицию и ресурсы." }],
