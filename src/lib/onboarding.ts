...
export const ONBOARDING_STEPS: readonly OnboardingStep[] = [
  ...
  },
  {
    ...
    description: "Выбери готовый или собственный кейс, определи свою роль и проведи голосовые переговоры с AI-оппонентом.",
  ...
  },
  {
    ...
    description: "Личный кабинет сохраняет историю рейтинговых тренировок, а общий рейтинг помогает сравнивать результаты.",
  ...
  },
  {
    ...
    description: "Загрузи готовый кейс или создай новый сценарий с помощью AI-конструктора.",
