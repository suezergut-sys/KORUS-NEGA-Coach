      ...
      <div className="admin-main about-page">
        ...
        <header className="admin-page-header about-header">
          <div>
            ...
            <p>Тренажёр управленческих переговоров: практика с AI-оппонентом, собственные кейсы, методический анализ и персональная траектория развития. Помогает руководителям и сотрудникам готовиться к управленческим переговорам, отрабатывать выбранную стратегию в голосовом поединке, превращать разбор каждой попытки в конкретный следующий шаг развития.</p>
          </div>
        </header>
