...
Репозиторий содержит работающий прототип. В нём реализованы один фиксированный кейс, два голоса оппонента, голосовой диалог через OpenAI Realtime API, RAG-анализ по книге Владимира Тарасова и закрытая панель проверки методических атомов.
...
- Доступен один захардкоженный кейс «Сорванный срок проекта».
