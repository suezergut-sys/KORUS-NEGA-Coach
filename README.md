...
- умный голос по умолчанию: каноническая роль содержит `voiceGender`, поэтому после выбора роли участника автоматически включается голос противоположной роли, которую играет ИИ; любой ручной выбор пользователя получает приоритет и сохраняется при дальнейшей смене ролей и кейсов;
...
- стартовый блок с кнопкой «Содержание кейса» расположен компактно рядом с панелью ожидающего аудиоввода, без большого пустого разрыва между ними;
