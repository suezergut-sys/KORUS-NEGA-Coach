...
- выбор длительности поединка: 3, 5, 10 или 15 минут; оставшееся время показывается на кнопке старта, замораживается на паузе, а по истечении срока тренажёр озвучивает завершение и автоматически запускает анализ;
