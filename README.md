...
- Поле автора кейса хранит отображаемую почту участника для новых загрузок и генераций; для исторических записей миграция проставляет обобщённый источник, поскольку прежняя схема не сохраняла автора.
