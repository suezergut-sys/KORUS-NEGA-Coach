...
- внизу панели настроек выбирается методология переговоров: методология Владимира Тарасова или Гарвардский метод; выбор фиксируется для последующего анализа и отчёта;
...
- поиск релевантных фрагментов только выбранной методологии через embeddings и pgvector;
...
- закрытая админ-панель с выбором методологии для подтверждения, отклонения и редактирования её атомов;
