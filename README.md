...
- нативные выпадающие меню выбора кейса и роли используют тёмную цветовую схему: пункты отображаются светлым текстом на тёмном фоне, а вся область поля, включая стрелку, раскрывает список; декоративные значки без подсказок в настройках не отображаются;
...
- административный реестр кейсов с датой загрузки, автором или источником генерации, статусом публикации, готовностью четырёхкадрового комикса отдельно для каждой роли и количеством отыгрышей;
