...
- сокращённый источник Гарвардского метода импортирован в приватное хранилище как `SRC-002`: 16 фрагментов и 37 атомов-кандидатов доступны методологу для проверки как `harvard-v0-candidate`.
