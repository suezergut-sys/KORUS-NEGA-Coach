...
- два стиля поединка: в режиме «Сотрудничество» оппонент ищет взаимовыгодное решение и не перебивает намеренно, а в режиме «Жёсткие переговоры» активнее продавливает позицию и получает возможность стратегически перебить собеседника не чаще одного раза на пять собственных реплик;
